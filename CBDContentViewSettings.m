...
- (void)save:(id)sender {
	UIAlertController *inputController = [UIAlertController alertControllerWithTitle:@"Name your layout" message:@"" preferredStyle:UIAlertControllerStyleAlert];

	[inputController addTextFieldWithConfigurationHandler:^(UITextField *textField) {}];

	UIAlertAction *confirmAction = [UIAlertAction actionWithTitle:@"Save" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
...
- (void)reset:(id)sender {
	UIAlertController *inputController = [UIAlertController alertControllerWithTitle:@"Are you sure?" message:@"Are you sure you want to reset your settings?" preferredStyle:UIAlertControllerStyleAlert];

	UIAlertAction *confirmAction = [UIAlertAction actionWithTitle:@"Reset settings" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
...
- (void)removeAll:(id)sender {
	UIAlertController *inputController = [UIAlertController alertControllerWithTitle:@"Are you sure?" message:@"Are you sure you want to remove all layouts?" preferredStyle:UIAlertControllerStyleAlert];

	UIAlertAction *confirmAction = [UIAlertAction actionWithTitle:@"Remove all" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	NSString *key = [[[[CBDManager sharedInstance] savedLayouts] allKeys] objectAtIndex:indexPath.row];
	UIAlertController *inputController = [UIAlertController alertControllerWithTitle:@"Are you sure?" message:[NSString stringWithFormat:@"Are you sure you want to restore saved layout \"%@\"?", key] preferredStyle:UIAlertControllerStyleAlert];

	UIAlertAction *confirmAction = [UIAlertAction actionWithTitle:@"Restore" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
...
- (NSArray *)tableView:(UITableView *)tableView editActionsForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	UITableViewRowAction *renameAction = [UITableViewRowAction rowActionWithStyle:UITableViewRowActionStyleNormal title:@"Rename" handler:^(UITableViewRowAction *action, NSIndexPath *indexPath) {  
		...
		UIAlertAction *confirmAction = [UIAlertAction actionWithTitle:@"Rename" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
			if ([inputController textFields][0].text) {
